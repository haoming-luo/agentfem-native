...
Scalar CSR is complete for this reference foundation. Native BSR,
block-Jacobi, C++20 sparse operations, threads, and stronger preconditioners
remain P3 work; therefore P3 as a whole is still active.
